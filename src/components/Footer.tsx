      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-12 grid gap-10 md:grid-cols-4">
        <div className="md:col-span-2">
          ...
          <p className="text-sm text-muted-foreground mt-3 max-w-sm">
            The creator studio for video, music, voice and scripts. Built for speed. You own every
            output.
          </p>
        </div>
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li>
              <Link to="/video" className="hover:text-foreground">
                Video
              </Link>
            </li>
            <li>
              <Link to="/music" className="hover:text-foreground">
                Music
              </Link>
            </li>
            <li>
              <Link to="/voice" className="hover:text-foreground">
                Voice-Over
              </Link>
            </li>
            <li>
              <Link to="/script" className="hover:text-foreground">
                Scripts
              </Link>
            </li>
          </ul>
