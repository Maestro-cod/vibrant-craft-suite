...
export function CreditMeter() {
  ...
  if (profile.unlimited) {
    return (
      <Link to="/pricing" className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-full glass text-xs hover:bg-white/10">
  ...
  return (
    <Link to="/pricing" className="hidden sm:flex items-center gap-2.5 px-3 py-1.5 rounded-full glass text-xs group hover:bg-white/10">
