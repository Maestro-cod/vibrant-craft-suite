  ...
  head: () => ({
    meta: [
      { title: "HyperPost AI — Create Video, Music, Voice & Scripts with AI" },
      {
        name: "description",
        content:
          "Generate cinematic video, original music, lifelike voice-over and viral scripts. Built for creators. No social posting. Just pure creation.",
      },
      { property: "og:title", content: "HyperPost AI — All your AI creation in one studio" },
      {
        property: "og:description",
        content:
          "Cinematic video, original music, lifelike voice & viral scripts. Download instantly. Post anywhere.",
      },
    ],
  }),
  component: Landing,
    ...
    <AppShell>
      ...
      <section className="relative mx-auto max-w-7xl px-4 sm:px-6 pt-20 pb-32 text-center">
        ...
        <p className="mt-8 max-w-2xl mx-auto text-lg text-muted-foreground animate-fade-up">
          Generate cinematic video, original music, lifelike voice-over and viral scripts — download
          instantly, post wherever you want.
        </p>
        <div className="mt-10 flex flex-wrap items-center justify-center gap-3 animate-fade-up">
          <Link
            to="/auth"
            className="px-6 py-3 rounded-xl bg-gradient-brand text-background font-semibold glow-cyan inline-flex items-center gap-2 hover:opacity-90 lift"
          >
            Start creating free <ArrowRight className="size-4" />
          </Link>
          <Link
            to="/pricing"
            className="px-6 py-3 rounded-xl glass font-semibold hover:bg-white/10"
          >
            See pricing
          </Link>
        </div>
        ...
        <div className="mt-16 flex flex-wrap items-center justify-center gap-x-8 gap-y-3 text-xs text-muted-foreground animate-fade-up">
          <div className="flex items-center gap-1.5">
            <Star className="size-3.5 text-[oklch(0.85_0.18_220)]" /> 3 free credits on signup
          </div>
          <div className="flex items-center gap-1.5">
            <Shield className="size-3.5 text-[oklch(0.85_0.18_220)]" /> No social posting, ever
          </div>
          <div className="flex items-center gap-1.5">
            <Download className="size-3.5 text-[oklch(0.85_0.18_220)]" /> Every output downloadable
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 pb-24">
        <Reveal>
          <h2 className="text-3xl sm:text-5xl font-bold text-center mb-3">
            One studio. <span className="text-gradient">Four superpowers.</span>
          </h2>
          <p className="text-muted-foreground text-center max-w-xl mx-auto">
            Each tool is purpose-built. None of the bloat.
          </p>
        </Reveal>
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {FEATURES.map(({ icon: Icon, title, desc, to }, i) => (
            <Reveal key={title} delay={i * 80}>
              <Link
                to={to}
                className="block glass rounded-2xl p-6 lift gradient-border h-full group"
              >
        ...
        <Reveal>
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-5xl font-bold">
              Prompt → result. <span className="text-gradient">No fluff.</span>
            </h2>
          </div>
        </Reveal>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            ...
            { icon: Download, title: "Yours forever", desc: "Every output has a download button." },
            {
              icon: Shield,
              title: "No socials",
              desc: "We never post for you. You own the moment.",
            },
        ...
        <Reveal>
          <div className="glass-strong rounded-3xl p-10 sm:p-16 text-center gradient-border relative overflow-hidden">
            ...
            <h2 className="relative text-3xl sm:text-5xl font-bold">
              Make your <span className="text-gradient">first 3 things</span> free.
            </h2>
            <p className="relative text-muted-foreground mt-3 max-w-lg mx-auto">
              No credit card. Sign up, get 3 credits, ship something today.
            </p>
            <Link
              to="/auth"
              className="relative mt-8 inline-flex items-center gap-2 px-7 py-3.5 rounded-xl bg-gradient-brand text-background font-semibold glow-cyan hover:opacity-90 lift"
            >
              Start creating free <ArrowRight className="size-4" />
            </Link>
          </div>
