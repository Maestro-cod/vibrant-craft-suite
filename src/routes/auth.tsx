...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      { title: "Sign in — HyperPost AI" },
      { name: "description", content: "Sign in or create your HyperPost AI account." },
    ],
  }),
  component: AuthPage,
});
        ...
        <GlassCard className="p-8">
          ...
          >
            <svg viewBox="0 0 48 48" className="size-5">
              ...
              <path
                fill="#4CAF50"
                d="M24 44c5.4 0 10.3-2.1 14-5.5l-6.5-5.3c-2 1.4-4.6 2.3-7.5 2.3-5.2 0-9.6-3.3-11.3-8l-6.5 5C9.5 39.6 16.2 44 24 44z"
              />
              <path
                fill="#1976D2"
                d="M43.6 20.5H42V20H24v8h11.3c-.8 2.2-2.2 4.1-4 5.5l6.5 5.3c-.5.4 6.7-4.9 6.7-14.8 0-1.3-.1-2.3-.4-3.5z"
              />
            </svg>
          ...
          <form onSubmit={onSubmit} className="space-y-3">
            ...
            <button
              disabled={loading}
              className="w-full py-2.5 rounded-xl bg-gradient-brand text-background font-semibold glow-cyan hover:opacity-90 disabled:opacity-50"
            >
