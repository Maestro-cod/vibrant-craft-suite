      ...
      <div className="mx-auto max-w-3xl px-4 pt-8 sm:px-6 space-y-6">
        ...
        <GlassCard className="space-y-8">
          <p className="text-sm text-muted-foreground">
            These Terms of Service ("Terms") govern your access to and use of HyperPost AI (the
          ...
          <Section title="3. Subscriptions and Credits">
            <p>
              Paid plans renew automatically until cancelled. Credits are consumed when generating
              content. Unused credits expire at the end of each billing cycle unless stated
              otherwise. All fees are non-refundable except where required by law.
            </p>
          </Section>

          <Section title="4. Acceptable Use">
            <p>
              You agree not to use the Service to create content that is illegal, infringing,
              defamatory, harassing, sexually explicit involving minors, or designed to deceive or
              harm others. We may suspend accounts that violate these rules.
            </p>
          </Section>

          <Section title="5. Content Ownership">
            <p>
              You retain ownership of the content you generate, subject to the licenses of the
              underlying AI providers. You are responsible for ensuring your prompts and outputs
          ...
          <Section title="6. Disclaimers">
            <p>
              The Service is provided "as is" without warranties of any kind. AI outputs may be
              inaccurate or unsuitable for your purposes. You use the Service at your own risk.
            </p>
          </Section>

          <Section title="7. Limitation of Liability">
            <p>
              To the maximum extent permitted by law, HyperPost AI is not liable for indirect,
              incidental, special, consequential, or punitive damages, or for lost profits or
              revenues. Our total liability is limited to the amount you paid us in the 12 months
              prior to the claim.
            </p>
          </Section>
          ...
          <Section title="8. Termination">
            <p>
              ...
              for violations of these Terms or for any reason with reasonable notice.
            </p>
          </Section>
          ...
          <Section title="10. Contact">
            <p>
              ...
              <a href="mailto:legal@hyperpostai.com" className="text-primary hover:underline">
                legal@hyperpostai.com
              </a>
              .
            </p>
          </Section>
