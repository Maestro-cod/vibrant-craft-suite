...
import { generateVoice } from "@/lib/audio.functions";
...
export const Route = createFileRoute("/voice")({
  head: () => ({
    meta: [
      { title: "Voice-Over — HyperPost AI" },
      { name: "description", content: "Generate lifelike voice-over with ElevenLabs." },
    ],
  }),
  component: VoicePage,
});
      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 pt-8 space-y-6">
        ...
        <GlassCard className="space-y-5 gradient-border">
          ...
          >
            ...
            {busy ? (
              <span className="shimmer">Synthesising voice…</span>
            ) : (
              "Generate voice (1 credit)"
            )}
          </button>
        </GlassCard>
